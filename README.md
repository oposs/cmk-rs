...
CmkRS is a cool web application.
...
```console
./configure --prefix=$HOME/opt/cmk-rs
make
```
...
You can now run cmk-rs.pl in reverse proxy mode.

```console
cd $HOME/opt/cmk-rs/bin
./cmk-rs.pl prefork
```
